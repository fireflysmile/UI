...
import { ProposedChangesCardComponent } from './proposed-changes-card.component';

const KEY = 'application';
describe('ProposedChangesCardComponent', () => {
  let component: ProposedChangesCardComponent;
  let fixture: ComponentFixture<ProposedChangesCardComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ProposedChangesCardComponent],
      imports: [
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ProposedChangesCardComponent);
