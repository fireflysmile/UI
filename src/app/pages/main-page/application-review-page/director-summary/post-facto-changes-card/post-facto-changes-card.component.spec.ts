...
import { PostFactoChangesCardComponent } from './post-facto-changes-card.component';

describe('PostFactoChangesCardComponent', () => {
  let component: PostFactoChangesCardComponent;
  let fixture: ComponentFixture<PostFactoChangesCardComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [PostFactoChangesCardComponent],
      imports: [
  ...
  beforeEach(() => {
    ...
    spyOn(applicationService, 'updateProposedChanges').and.returnValue(
      of({} as any)
    );
    ...
    fixture = TestBed.createComponent(PostFactoChangesCardComponent);
